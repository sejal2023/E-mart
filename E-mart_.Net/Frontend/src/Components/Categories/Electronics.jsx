...
const ProductPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      if (subcategoryId) {
        url = `http://localhost:5208/api/Product/subcategories/${subcategoryId}`;
      } else {
        url = `http://localhost:5208/api/Product/categories/${categoryId}`;
      }
                  ...
                  <div key={product.productid} className="col-md-4 mb-4">
                    <div className="card shadow-lg p-3 border rounded">
                      ...
                      <div className="card-body">
                        ...
                        <Link to={`/product/${product.productid}`} className="btn btn-info mt-3 w-100">
                          View Details
                        </Link>
                      </div>
                    </div>
